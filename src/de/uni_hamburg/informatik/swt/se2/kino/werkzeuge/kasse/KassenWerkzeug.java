...
import de.uni_hamburg.informatik.swt.se2.kino.werkzeuge.BeobachtbaresWerkzeug;
...
public class KassenWerkzeug
{
    ...
    private final VorstellungsAuswaehlWerkzeug _vorstellungAuswaehlWerkzeug;
    ...
    /**
     * Registriert Callback Funktionen als Beobachter für Veränderungen des
     * aktuellen Zustands
     */
    private void registriereBeobachter()
    {
        _vorstellungAuswaehlWerkzeug.registriereBeobachter(
                this::setzeAusgewaehlteVorstellung);
        _datumAuswaehlWerkzeug.registriereBeobachter(
                this::setzeTagesplanFuerAusgewaehltesDatum);
    }
